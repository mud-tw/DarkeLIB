...
cmd_score(string who)
{
    ...
    if (!who) op = tp;
    else if (!wizardp(tp)) return 0;
    else if (!(op = find_living(who))) return 0;
    else if (!(op = find_living(who))) return 0;
    ...
    if (age2 > 86400)
        age3 = (age2 / 86400 + " Days");
    else if (age2 > 3600)
        age3 = (age2 / 3600) + " Hours";
    else
        age3 = (age2 / 60) + " Min";
